...
if __name__ == "__main__":
    ...
    N= 10**4  #number of training data points
    ...
    flip_y=0.3, #introduces some random class allocation
    ...
    save_path = './lr_balance_train_synth.csv'
    df_train.to_csv(save_path, ",", index=False)
    print("Saving test datset" )
    save_path = './lr_balance_test_synth.csv'
